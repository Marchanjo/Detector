...
#include "tensorflow/examples/Detector/jni/tensorflow/object_tracking/frame_pair.h"
#include "tensorflow/examples/Detector/jni/tensorflow/object_tracking/image_data.h"
#include "tensorflow/examples/Detector/jni/tensorflow/object_tracking/keypoint.h"
