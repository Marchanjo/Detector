...
#include "tensorflow/examples/Detector/jni/tensorflow/rgb2yuv.h"
#include "tensorflow/examples/Detector/jni/tensorflow/yuv2rgb.h"

#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_com_dji_Detector_env_ImageUtils_##METHOD_NAME  // NOLINT
