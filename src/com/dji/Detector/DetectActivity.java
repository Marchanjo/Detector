...
import com.dji.Detector.OverlayView.DrawCallback;
...
import com.dji.Detector.R; // Explicit import needed for internal Google builds.
...
public class DetectActivity extends CamActivity implements OnImageAvailableListener {
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        LOGGER.i("PROCESSING TIME TENSORFLOW - SMARTPHONE CAMERA : " + lastProcessingTimeMs);
